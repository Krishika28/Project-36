...
var dog, happyDog, database, feed,foodStock, dog_img, happy_img,fedTime, lastFed,foodObj, changing_gameState,reading_gameState;
...
foodObj = new food();
  ...
  reading_gameState = database.ref('GameState');
  reading_gameState.on("value",function(data){
    GameState = data.val();
  });
